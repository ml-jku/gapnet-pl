...
from pyll.base import TorchModel
...
def densenet121_multitask(**kwargs):
    r"""Densenet-121 model from
    `"Densely Connected Convolutional Networks" <https://arxiv.org/pdf/1608.06993.pdf>`_
    """
...
class DenseNet(TorchModel):
    ...
    def __init__(self, model_params):
        ...
        num_in_channels = model_params.num_in_channels
        ...
        self.features = nn.Sequential(OrderedDict([
            ('conv0', nn.Conv2d(num_in_channels, num_init_features, kernel_size=7, stride=2, padding=3, bias=False)),
    ...
    def forward(self, x):
        ...
        out = F.avg_pool2d(out, kernel_size=out.size()[-2:], stride=1).view(features.size(0), -1)
